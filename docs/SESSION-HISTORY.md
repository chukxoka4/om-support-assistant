...
| `4b3848c6…` | 2026-07-10 | **Claude Code connector — Slice 0.** Ratified decisions DEC-A…E with the owner (all confirmed as-written) and recorded them as DECISIONS D34–D38; listed doc 10 in the index. Docs-only slice; no code. On `joseph-dev`, no branching (owner directive). | [10-CLAUDE-CODE-CONNECTOR.md](10-CLAUDE-CODE-CONNECTOR.md), DECISIONS D34–D38, 00-INDEX |
