...
const TERMINAL_OUTCOMES = new Set(["sent", "manager_approved"]);
...
export async function getUnresolvedDeliveredByConversation(conversationId) {
  ...
  return drafts.filter((d) =>
    d.delivery_action &&
    !TERMINAL_OUTCOMES.has(d.outcome) &&
    !(d.outcome === "rewrote" && d.correction_logged) &&
    !(d.outcome === "edited" && d.correction_logged)
  );
}
